...
$english = array(
	 ...
	 * Answers river
	 */
	'question:river:created' => "%s asked",
	'question:river:answered' => "%s answered the question",
	'question:river:chosen' => "%s chose the best answer to the question",
	'question:river:updated' => "%s updated the question",
	'question:river:comment:question' => "%s commented on the question",
	'question:river:comment:answer' => "%s commented on an answer to the question",
